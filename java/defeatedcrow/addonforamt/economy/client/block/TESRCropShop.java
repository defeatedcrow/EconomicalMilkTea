...
public class TESRCropShop extends TileEntitySpecialRenderer {

	private static final ResourceLocation tex = new ResourceLocation(EcoMTCore.PACKAGE
			+ ":textures/blocks/tileentity/cropshop.png");
	public static TESRCropShop renderer;
	private ModelCropShop model = new ModelCropShop();

	public void renderTileEntitySteakAt(TileDisplayShop tile, double par2, double par4, double par6, float par8) {
	...
	public void setRotation(TileDisplayShop tile, float x, float y, float z) {
		...
		for (int i = 0; i < 4; i++) {
			...
			GL11.glTranslatef(fx[i], fy[i], fz[i]);
	...
	private void renderInner(TileDisplayShop tile, int i) {
		...
		if (slot != null) {
			...
			entityitem.getEntityItem().stackSize = 8;
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		this.renderTileEntitySteakAt((TileDisplayShop) par1TileEntity, par2, par4, par6, par8);
	}
}
