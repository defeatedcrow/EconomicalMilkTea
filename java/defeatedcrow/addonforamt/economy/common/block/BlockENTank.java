...
public class BlockENTank extends BlockContainer {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
		...
		TileENTank tile = null;
		if (tileentity != null && tileentity instanceof TileENTank) {
			tile = (TileENTank) tileentity;
		}
		if (tile != null) {
			if (par1World.isRemote) {
				return true;
			} else {
				par5EntityPlayer.openGui(EcoMTCore.instance, EcoMTCore.instance.guiTank, par1World, par2, par3, par4);
				return true;
			}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
		...
		TileENTank tileentity = null;
		if (tile != null && tile instanceof TileENTank) {
			tileentity = (TileENTank) tile;
		}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase,
		...
		TileEntity tile = par1World.getTileEntity(par2, par3, par4);
		if (tile != null && tile instanceof TileENTank) {
			((TileENTank) tile).setChargeAmount(charge);
