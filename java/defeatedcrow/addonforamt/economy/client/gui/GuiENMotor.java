...
public class GuiENMotor extends GuiContainer {

	private TileENMotor tileentity;

	public GuiENMotor(EntityPlayer player, TileENMotor par2TileEntity) {
		super(new ContainerENMotor(player, par2TileEntity));
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int x, int y) {
		...
		this.mc.getTextureManager().bindTexture(new ResourceLocation(EcoMTCore.PACKAGE, "textures/gui/motor_gui.png"));
