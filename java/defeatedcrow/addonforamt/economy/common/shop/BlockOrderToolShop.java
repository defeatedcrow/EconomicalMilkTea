...
import defeatedcrow.addonforamt.economy.plugin.mce.OrderShopList;

public class BlockOrderToolShop extends BlockContainer {

	public BlockOrderToolShop() {
		super(Material.clay);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7,
		...
		if (world.isRemote) {
			...
			MCEconomyAPI.openShopGui(OrderShopList.thishopId, player, world, x, y, z);
		}
