...
public class TESRENTank extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation tex = new ResourceLocation(EcoMTCore.PACKAGE
			+ ":textures/blocks/tileentity/entank.png");
	public static TESRENTank renderer;
	private ModelENTank model = new ModelENTank();

	public void renderTileEntitySteakAt(TileENTank par1Tile, double par2, double par4, double par6, float par8) {
	...
	public void setRotation(TileENTank par0Tile, float par1, float par2, float par3) {
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		this.renderTileEntitySteakAt((TileENTank) par1TileEntity, par2, par4, par6, par8);
	}
}
