...
public class BlockENMotor extends BlockContainer {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
		...
		TileENMotor tile = null;
		if (tileentity != null && tileentity instanceof TileENMotor) {
			tile = (TileENMotor) tileentity;
		}
		if (tile != null) {
			if (par1World.isRemote) {
				return true;
			} else {
				par5EntityPlayer.openGui(EcoMTCore.instance, EcoMTCore.instance.guiMotor, par1World, par2, par3, par4);
				return true;
			}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
		...
		TileENMotor tileentity = null;
		if (tile != null && tile instanceof TileENMotor) {
			tileentity = (TileENMotor) tile;
		}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase,
		...
		TileEntity tile = par1World.getTileEntity(par2, par3, par4);
		if (tile != null && tile instanceof TileENMotor) {
			((TileENMotor) tile).setChargeAmount(charge);
